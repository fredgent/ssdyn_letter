...
is occuppies a cube of length 120 pc, with periodic boundaries on all sides and
...
\begin{figure*}
\gridline{\fig{figs/pb05pcPm0e-4_02.png}{0.3\textwidth}{(a)}
          \fig{figs/pb1pcPm0e-4_00.png}{0.3\textwidth}{(b)}
          \fig{figs/pb2pcPm0e-4_00.png}{0.3\textwidth}{(c)}
          }
\gridline{\fig{figs/tt05pcPm0e-4_02.png}{0.3\textwidth}{(d)}
          \fig{figs/tt1pcPm0e-4_00.png}{0.3\textwidth}{(e)}
          }
\gridline{\fig{figs/tt2pcPm0e-4_00.png}{0.3\textwidth}{(f)}}
