...
%Journals peer review system.
  The first lesson in the tutorial is to remind
...
%(RNAAS) do \textbf{not} have abstracts.}.
  If you exceed this length the
...
\begin{figure}[ht!]
\plotone{figs/eB-res-4eta.png}
\plotone{figs/eB-res-3eta.png}
\caption{
...
Resistivity, $\eta=10^{-4}$\,kpc\,km\,s$^{-1}$ in panel {\bf(a)} and $10^{-3}$
...
\gridline{\fig{figs/2pc-eB-nu3.png}{0.45\textwidth}{(c)}
          \fig{figs/2pc-eB-nu6.png}{0.45\textwidth}{(d)}
          }
\gridline{\fig{figs/4pc-eB-nu3.png}{0.45\textwidth}{(e)}
          \fig{figs/4pc-eB-nu0.png}{0.45\textwidth}{(f)}
          }
\caption{
For each resolution the effect of $\eta$ is compared, {\bf(a)} 0.5\,pc, {\bf(b)}
1\,pc, {\bf(c)} and {\bf(d)} 2\,pc, and {\bf(e)} and {\bf(f)} 4\,pc.
All models have supernova rate $0.2\sigma_{\rm SN}$, except {\bf(d)} and
{\bf(f)}, which have $\sigma_{\rm SN}$.
$\sigma_{\rm SN}\simeq 50$\,kpc$^{-3}$\,Myr$^{-1}$ is the solar neighbourhood
equivalent random SN frequency.
\label{fig:eb-nu}}
\end{figure*}
...
\begin{figure*}
\gridline{\fig{figs/0_5pcPm0e-4_0Bpower.png}{0.4\textwidth}{(a)}
          \fig{figs/0_5pcPm0e-4_0kpower.png}{0.4\textwidth}{(b)}
          }
\gridline{\fig{figs/1pcPm0e-4_0Bpower.png}{0.4\textwidth}{(c)}
          \fig{figs/1pcPm0e-4_0kpower.png}{0.4\textwidth}{(d)}
          }
\gridline{\fig{figs/2pcPm0e-4_0Bpower.png}{0.4\textwidth}{(e)}
          \fig{figs/2pcPm0e-4_0kpower.png}{0.4\textwidth}{(f)}
          }
\gridline{\fig{figs/4pcPm0e-4_0Bpower.png}{0.4\textwidth}{(g)}
          \fig{figs/4pcPm0e-4_0kpower.png}{0.4\textwidth}{(h)}
          }
\caption{
Magentic (left) and kinetic (right) energy spectra for each model resolution
with a super critical dynamo Rm ($\eta=10^{-4}$).
\label{fig:4power}}
\end{figure*}

\begin{figure*}
\gridline{\fig{figs/0_5pcPm0e-3_0Bpower.png}{0.4\textwidth}{(a)}
          \fig{figs/0_5pcPm0e-3_0kpower.png}{0.4\textwidth}{(b)}
          }
\gridline{\fig{figs/1pcPm0e-3_0Bpower.png}{0.4\textwidth}{(c)}
          \fig{figs/1pcPm0e-3_0kpower.png}{0.4\textwidth}{(d)}
          }
\gridline{\fig{figs/2pcPm0e-3_0Bpower.png}{0.4\textwidth}{(e)}
          \fig{figs/2pcPm0e-3_0kpower.png}{0.4\textwidth}{(f)}
          }
\gridline{\fig{figs/4pcPm0e-3_0Bpower.png}{0.4\textwidth}{(g)}
          \fig{figs/4pcPm0e-3_0kpower.png}{0.4\textwidth}{(h)}
          }
\caption{
Magentic (left) and kinetic (right) energy spectra for each model resolution
with a sub critical dynamo Rm ($\eta=10^{-3}$).
\label{fig:3power}}
\end{figure*}
...
%\figsetplot{figs/1pcPm0e-4_0Bpower.png}
...
%\figsetplot{figs/1pcPm0e-4_0kpower.png}
%\figsetgrpnote{The Swift/XRT X-ray light curve for the first year after
%outburst of RS Oph.}
%\figsetgrpend
%
...
%\figsetplot{figs/2pcPm0e-4_02SNBpower.png}
%\figsetgrpnote{The Swift/XRT X-ray light curve for the first year after
%outburst of U Sco.}
%\figsetgrpend
%
...
%\figsetplot{figs/2pcPm0e-4_02SNkpower.png}
%\figsetgrpnote{The Swift/XRT X-ray light curve for the first year after
...
%\figsetplot{figs/4pcPm0e-4_02SNBpower.png}
%\figsetgrpnote{The Swift/XRT X-ray light curve for the first year after
...
%\figsetplot{figs/4pcPm0e-4_02SNkpower.png}
%\figsetgrpnote{The Swift/XRT X-ray light curve for the first year after
%outburst of HV Cet.}
%\figsetgrpend
%
...
%
%\begin{figure}
%\plotone{figs/4pcPm0e-4_02SNkpower.png}
