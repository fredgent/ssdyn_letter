...
\begin{figure*}[ht!]
\plottwo{figs/eB-res-4eta.png}{figs/eB-res-3eta.png}
\caption{
...
\gridline{\fig{figs/2pc-eB-nu3.png}{0.45\textwidth}{(c)}
          \fig{figs/4pc-eB-nu3.png}{0.45\textwidth}{(d)}
          }
\gridline{
          \fig{figs/2pc-eB-nu6.png}{0.45\textwidth}{(e)}
...
\gridline{\fig{figs/0_5pcPm0e-3_0Bpower.png}{0.4\textwidth}{(c)}
          \fig{figs/0_5pcPm0e-3_0kpower.png}{0.4\textwidth}{(d)}
          }
\caption{
Magentic (a) and kinetic (b) energy spectra evolving over time
...
\caption{
Magentic (left) and kinetic (right) energy spectra at dynamo 
saturation (or late time) for each resolution with
$eta=0,\,10^{-4}$ and $10^{-3}$ panel pairs (a,b), (c,d) and
(e,f), respectively.
Comparison of supernova rate at 2\,pc resolution, in panels (g,h),
 $\sigma=0.2\sigma_{\rm SN}$
and $\sigma_{\rm SN}$ for $\eta=10^{-3}$ and $10^{-3}$.
\label{fig:3power}}
\end{figure*}
