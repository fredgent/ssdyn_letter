...
\gridline{
  ...
  \begin{picture}(0,0)(0,0)
    \put( 56,458){\begin{scriptsize}{\sf{$\delta x=0.5$pc}}\end{scriptsize}}
    \put(450,458){\begin{scriptsize}{\sf{$\delta x=1.0$pc}}\end{scriptsize}}
    \put( 56,271){\begin{scriptsize}{\sf{$\delta x=2.0$pc}}\end{scriptsize}}
    \put(450,271){\begin{scriptsize}{\sf{$\delta x=4.0$pc}}\end{scriptsize}}
    \put( 56, 83){\begin{scriptsize}{\sf{$\delta x=2.0$pc}}\end{scriptsize}}
    \put(450, 83){\begin{scriptsize}{\sf{$\delta x=4.0$pc}}\end{scriptsize}}
  \end{picture}
\caption{
...
\tablewidth{0pt}
\tablehead{
\colhead{Notation} & \colhead{Meaning} & \colhead{Units/Definition} 
\\
}
%\decimalcolnumbers
\startdata\\
