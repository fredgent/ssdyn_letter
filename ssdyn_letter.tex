...
%==============================================================================
 ...
 Strong ordered magnetic field effects are modeled by
...
\caption{
 ...
 Time is normalized by eddy turnover time, $1/\kf {u_{\rm rms}}$.
...
%-------------------------------------------------------------------------------
 ...
 \fg{This snapshot reflects the overall behavior of the system, in which
...
\caption{
 ...
 Panels (a)--(c): {samples at $t=27.5\Myr$ for $\dx$ {given
    in the legend} for
 ...
 Panel (d): samples taken {at different times but} similar field strength at
...
{Figure~\ref{fig:eb-res} shows
 ...
 {We ran models to reproduce the results of \BKM, which adopt their choice of
...
%-------------------------------------------------------------------------------
 ...
 {a physical resistivity of $\eta=10^{-5}$ {(panels (a1) and (a2))}
 ...
 viscosity
 (Fig\,\ref{fig:eb-nu} (a), (c), and (d)), $\eta\geq10^{-3}$ initially appears
...
Resistivity is $\eta=10^{-4}$ with (b1)--(b2) as a comparison to $\BKM$.}
 \label{fig:4power}}
\end{figure}
%-------------------------------------------------------------------------------
 ...
 This is a regime less conducive to exciting the SSD than the high $\Pm$
...
{We now examine whether the field growth seen in our models could
 ...
 The compensated magnetic energy spectra in Figure\,\ref{fig:4power}\,(a1) and (b1)
...
{likely occurs easily}
 ...
 We find that the conventional approach from dynamo theory of categorizing the 
