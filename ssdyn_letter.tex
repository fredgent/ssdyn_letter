...
Figure\,\ref{fig:tangling}. Panel (a) illustrates that the small scale dynamo 
...
just over 400 turnover times. Tangling results only in linear amplification
early on (see inset) saturating to about 2.5 times the original field strength.
...
The SSD magnetic spectrum (b) evolves near self-similarly, with a peak
...
A dashed black line indicates the Kazentsev \fag{Anyone, a suitable reference
for this expected behaviour?} $3/2$ power law.
This corresponds to the gradient at wavenumbers around $\kf$ in the SSD case,
but at lower wavenumbers only in the case of tangling.


\section{Model design} \label{sec:model}


Alternatively, some large scale models do include the large scale dynamo 
