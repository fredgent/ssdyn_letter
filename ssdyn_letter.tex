...
%-------------------------------------------------------------------------------
 ...
 $(x,y)=(0.08,0.02)$, which has below average gas density.
 Hence, magnetic field amplification occurs independently of shock
 compression.}    
...
%-------------------------------------------------------------------------------
 ...
 While the dynamo amplifies the magnetic energy 4 -- 6 orders of magnitude,
 $\rho^{4/3}$ indicative of density fluctuations is only 1.6.
}
