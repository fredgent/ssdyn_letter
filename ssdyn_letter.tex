...
The right axis indicates the magnetic energy density in terms of the
...
\begin{figure*}[ht!]
\gridline{\fig{figs/eB-res-4etab.png}{0.43\textwidth}{(a)}
          \fig{figs/eB-res-3etab.png}{0.43\textwidth}{(b)}
          }
\caption{
The volume averaged magnetic energy density for models with resolution
between 0.5\,pc and 4\,pc are plotted over time.
...
\gridline{
  ...
  \begin{picture}(0,0)(0,0)
    \put(130,488){\begin{scriptsize}{\sf{$\delta x=0.5$pc}}\end{scriptsize}}
    \put(390,488){\begin{scriptsize}{\sf{$\delta x=1.0$pc}}\end{scriptsize}}
    \put(130,320){\begin{scriptsize}{\sf{$\delta x=2.0$pc}}\end{scriptsize}}
    \put(390,320){\begin{scriptsize}{\sf{$\delta x=4.0$pc}}\end{scriptsize}}
    \put(130,152){\begin{scriptsize}{\sf{$\delta x=2.0$pc}}\end{scriptsize}}
    \put(390,152){\begin{scriptsize}{\sf{$\delta x=4.0$pc}}\end{scriptsize}}
  \end{picture}
\caption{
For each resolution, {\rm(a)} 0.5\,pc, {\rm(b)}
1\,pc, {\rm(c)} and {\rm(e)} 2\,pc, and {\rm(d)} and {\rm(f)} 4\,pc the effect
 of resistivity $\eta$ is compared.
All models have supernova rate $\sigma=0.2\sigma_{\rm SN}$, except {\rm(e)} and
{\rm(f)}, which have $\sigma=\sigma_{\rm SN}$, where
...
\caption{
Magentic (a) and kinetic (b) compensated energy spectra evolving over time
for 0.5\,pc resolution
with Rm super critical for dynamo($\eta=10^{-4}$) and 
(c) and (d) respective energy spectra
with Rm sub critical or marginal for dynamo ($\eta=10^{-3}$).
Magnetic energy spectra are compensated for Kazentsev $k^{3/2}$ and kinetic
for Kolmogorov $k^{-5/3}$ theoretical profiles, each represented by the 
...
\caption{
Magentic (left) and kinetic (right) compensated energy spectra at dynamo 
saturation (or late time) for each resolution with
$\eta=0,\,10^{-4}$ and $10^{-3}$ panel pairs (a,b), (c,d) and
(e,f), respectively.
Magnetic energy spectra are compensated for Kazentsev $k^{3/2}$ and kinetic
for Kolmogorov $k^{-5/3}$ theoretical profiles, each represented by the 
horizontal black dashed lines.
Comparison of supernova rate at 2\,pc resolution at 200\,Myr, in panels (g,h),
 $\sigma=0.2\sigma_{\rm SN}$
and $\sigma=\sigma_{\rm SN}$ for $\eta=10^{-4}$ and $10^{-3}$.
\label{fig:3power}}
\end{figure*}
