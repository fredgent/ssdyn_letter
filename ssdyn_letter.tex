...
\gridline{\fig{figs/2pc-eB-nu3.png}{0.5\textwidth}{(c)}
          \fig{figs/2pc-eB-nu6.png}{0.5\textwidth}{(d)}
          }
\gridline{\fig{figs/4pc-eB-nu3.png}{0.5\textwidth}{(e)}
          \fig{figs/4pc-eB-nu0.png}{0.5\textwidth}{(f)}
          }
\caption{Inverted pyramid figure of six individual files.
\label{fig:pyramid}}
\end{figure*}
...
\gridline{\fig{figs/0_5pcPm0e-4_0Bpower.png}{0.5\textwidth}{(a)}
          \fig{figs/1pcPm0e-4_0Bpower.png}{0.5\textwidth}{(b)}
          }
\gridline{\fig{figs/2pcPm0e-4_0Bpower.png}{0.5\textwidth}{(c)}
          \fig{figs/4pcPm0e-4_0Bpower.png}{0.5\textwidth}{(d)}
          }
\gridline{\fig{figs/0_5pcPm0e-4_0kpower.png}{0.5\textwidth}{(e)}
          \fig{figs/1pcPm0e-4_0kpower.png}{0.5\textwidth}{(f)}
          }
\gridline{\fig{figs/2pcPm0e-4_0kpower.png}{0.5\textwidth}{(g)}
          \fig{figs/4pcPm0e-4_0kpower.png}{0.5\textwidth}{(h)}
          }
\caption{Inverted pyramid figure of six individual files.
\label{fig:pyramid}}
\end{figure*}
...
\begin{figure*}
\gridline{\fig{figs/0_5pcPm0e-3_0Bpower.png}{0.5\textwidth}{(a)}
          \fig{figs/1pcPm0e-3_0Bpower.png}{0.5\textwidth}{(b)}
          }
\gridline{\fig{figs/2pcPm0e-3_0Bpower.png}{0.5\textwidth}{(c)}
          \fig{figs/4pcPm0e-3_0Bpower.png}{0.5\textwidth}{(d)}
          }
\gridline{\fig{figs/0_5pcPm0e-3_0kpower.png}{0.5\textwidth}{(e)}
          \fig{figs/1pcPm0e-3_0kpower.png}{0.5\textwidth}{(f)}
          }
\gridline{\fig{figs/2pcPm0e-3_0kpower.png}{0.5\textwidth}{(g)}
          \fig{figs/4pcPm0e-3_0kpower.png}{0.5\textwidth}{(h)}
          }
\caption{Inverted pyramid figure of six individual files.
\label{fig:pyramid}}
\end{figure*}
