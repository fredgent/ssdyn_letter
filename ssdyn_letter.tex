...
{Figure~\ref{fig:eb-res} shows
 ...
 %MJK Repeat: what strikes me here is that in both SN rate cases, the rapid growth starts only when Ms gets below 1. For both SN rates, therefore, there seems to be a stronger dynamo after the Ms has dropped below 1. This contradicts your contradiction. Your conclusion is based on comparing the growth rates and Ms during the kinematic stage, but this is far less evident, as now one should compare log-lin plots with log-log plots, and then I am no longer sure what I see.
