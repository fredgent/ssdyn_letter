...
consistent with SSD action,
      ...
      %NS: used \cite for Balsara et al to highlight also the year; pls check
...
%==============================================================================
 ...
 and $\eta=2\cdot10^{-3}$.
 %These yield
 %NS: Added Respectively in the beginning
...
\caption{
 ...
 %NS: should we reverse the order as "viscosity nu and delta x", in the above sentence?
