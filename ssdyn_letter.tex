...
\mm{We now examine whether the field growth seen in our models could
  ...
  based on our isothermal models that tangling should produce linear growth rate and that only an inverse
  ...
  growth and a direct Kazantsev cascade extending below the forcing scale.}
