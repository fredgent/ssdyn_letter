...
\begin{figure*}
\gridline{\fig{figs/nu0_Bpower.png}{0.43\textwidth}{(a)}
          \fig{figs/nu0_kpower.png}{0.43\textwidth}{(b)}
          }
\gridline{\fig{figs/nu10_Bpower.png}{0.43\textwidth}{(c)}
          \fig{figs/nu10_kpower.png}{0.43\textwidth}{(d)}
          }
\gridline{\fig{figs/nu1_Bpower.png}{0.43\textwidth}{(e)}
          \fig{figs/nu1_kpower.png}{0.43\textwidth}{(f)}
          }
\gridline{\fig{figs/SN_Bpower.png}{0.43\textwidth}{(g)}
          \fig{figs/SN_kpower.png}{0.43\textwidth}{(h)}
          }
\caption{
